...
var invariant = _interopRequireWildcard(_invariant);
    ...
    var ComponentWithRoute = (function (_Component) {
        ...
        _createClass(ComponentWithRoute, [{
            ...
            value: function componentDidMount() {
                ...
                invariant(this.router.registeredPlugins.LISTENERS, '[react-router5] missing plugin router5-listeners.');
            ...
            value: function render() {
                invariant(!props.router && !props.route && !props.previousRoute, '[react-router5] prop names `router`, `route` and `previousRoute` are reserved.');
