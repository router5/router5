...
function withRouter(BaseComponent) {
    var WithRouter = /** @class */ (function (_super) {
        ...
        WithRouter.prototype.render = function () {
            return createElement(BaseComponent, __assign(__assign({}, this.props), { router: this.router }));
        };
...
function withRoute(BaseComponent) {
    var WithRoute = /** @class */ (function (_super) {
        ...
        WithRoute.prototype.render = function () {
            return createElement(BaseComponent, __assign(__assign(__assign({}, this.props), this.routeState), { router: this.router }));
        };
    ...
    return function routeNodeWrapper(RouteSegment) {
        var RouteNode = /** @class */ (function (_super) {
            ...
            RouteNode.prototype.render = function () {
                ...
                var component = createElement(RouteSegment, __assign(__assign({}, props), { router: router,
                    previousRoute: previousRoute,
                    route: route }));
                return component;
            };
...
export { BaseLink, ConnectedLink, Link, RouterProvider, routeNode, withRoute, withRouter };
