...
* fix error codes object name in TypesSript definitions [@iotch](https://github.com/iotch) ([17bae62](https://github.com/router5/router5/commit/17bae62))
...
* add incremented id to meta property of state objects ([1699465](https://github.com/router5/router5/commit/1699465))



<a name="4.4.1"></a>
## [4.4.1](https://github.com/router5/router5/compare/v4.4.0...v4.4.1) (2017-01-19)


### Bug Fixes

* update route-node version to latest (1.8.1) ([417787f](https://github.com/router5/router5/commit/417787f))
...
* update route-node package ([74487f1](https://github.com/router5/router5/commit/74487f1))



<a name="4.2.2"></a>
## [4.2.2](https://github.com/router5/router5/compare/v4.2.1...v4.2.2) (2016-10-04)


### Bug Fixes

* update route-node package ([1116f8b](https://github.com/router5/router5/commit/1116f8b))
...
<a name="2.0.1"></a>
## [2.0.1](https://github.com/router5/router5/compare/v2.0.0...v2.0.1) (2016-01-19)
